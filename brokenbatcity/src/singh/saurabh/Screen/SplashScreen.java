...
import singh.saurabh.TweenAccessors.SpriteAccessor;
...
public class SplashScreen implements Screen {
	...
	public SplashScreen(BBCGame game) {
		this.game = game;
	}
	...
	private void setupTween() {
		...
		Tween.to(sprite, SpriteAccessor.ALPHA, 2).target(1)
				.ease(TweenEquations.easeInOutQuad).repeatYoyo(1, 2)
